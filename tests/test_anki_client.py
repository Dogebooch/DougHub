...
def test_get_version_success(mock_ankiconnect, client):
...
def test_get_version_connection_error(mock_ankiconnect, client):
...
def test_get_version_api_error(mock_ankiconnect, client):
...
def test_check_connection_success(mock_ankiconnect, client):
...
def test_check_connection_failure(mock_ankiconnect, client):
...
def test_get_deck_names(mock_ankiconnect, client):
...
def test_get_deck_names_and_ids(mock_ankiconnect, client):
...
def test_get_decks(mock_ankiconnect, client):
...
def test_find_notes(mock_ankiconnect, client):
...
def test_get_notes_info(mock_ankiconnect, client):
...
def test_get_notes_info_empty_list(mock_ankiconnect, client):
    """Test getting notes info with empty list."""
    notes = client.get_notes_info([])
    assert notes == []


def test_get_model_names(mock_ankiconnect, client):
...
def test_get_model_names_and_ids(mock_ankiconnect, client):
...
def test_get_note_types(mock_ankiconnect, client):
...
def test_get_model_field_names(mock_ankiconnect, client):
...
def test_get_model_field_names_not_found(mock_ankiconnect, client):
...
def test_add_note_success(mock_ankiconnect, client):
...
def test_add_note_deck_not_found(mock_ankiconnect, client):
...
def test_add_note_model_not_found(mock_ankiconnect, client):
    """Test error when note type does not exist."""
    mock_ankiconnect.post("/").mock(
        return_value=Response(
            200, json={"result": None, "error": "model was not found"}
...
def test_add_note_invalid_fields(mock_ankiconnect, client):
...
def test_update_note_fields_success(mock_ankiconnect, client):
...
def test_update_note_fields_not_found(mock_ankiconnect, client):
...
def test_update_note_fields_invalid(mock_ankiconnect, client):
...
def test_context_manager(mock_ankiconnect):
