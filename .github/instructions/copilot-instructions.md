...
# DougHub – AI Coding Assistant Instructions

You are an AI coding assistant (e.g., GitHub Copilot, Gemini Code Assist) working inside this repository.

Your purpose is to make precise, high-quality, safe code changes that align with this project’s structure, tooling, and the human’s intent. Follow every rule in this file.
...
1. Correctness, safety and end UX.
